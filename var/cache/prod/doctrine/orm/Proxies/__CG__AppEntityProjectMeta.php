 ...
 */
class ProjectMeta extends \App\Entity\ProjectMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\ProjectMeta' . "\0" . 'project', '' . "\0" . 'App\\Entity\\ProjectMeta' . "\0" . 'id', '' . "\0" . 'App\\Entity\\ProjectMeta' . "\0" . 'name', '' . "\0" . 'App\\Entity\\ProjectMeta' . "\0" . 'value', '' . "\0" . 'App\\Entity\\ProjectMeta' . "\0" . 'visible', '' . "\0" . 'App\\Entity\\ProjectMeta' . "\0" . 'type', '' . "\0" . 'App\\Entity\\ProjectMeta' . "\0" . 'required', '' . "\0" . 'App\\Entity\\ProjectMeta' . "\0" . 'constraints'];
        }
