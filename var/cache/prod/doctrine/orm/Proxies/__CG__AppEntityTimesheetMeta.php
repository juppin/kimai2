 ...
 */
class TimesheetMeta extends \App\Entity\TimesheetMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\TimesheetMeta' . "\0" . 'timesheet', '' . "\0" . 'App\\Entity\\TimesheetMeta' . "\0" . 'id', '' . "\0" . 'App\\Entity\\TimesheetMeta' . "\0" . 'name', '' . "\0" . 'App\\Entity\\TimesheetMeta' . "\0" . 'value', '' . "\0" . 'App\\Entity\\TimesheetMeta' . "\0" . 'visible', '' . "\0" . 'App\\Entity\\TimesheetMeta' . "\0" . 'type', '' . "\0" . 'App\\Entity\\TimesheetMeta' . "\0" . 'required', '' . "\0" . 'App\\Entity\\TimesheetMeta' . "\0" . 'constraints'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TimesheetMeta $proxy) {
