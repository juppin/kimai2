 ...
 */
class CustomerMeta extends \App\Entity\CustomerMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\CustomerMeta' . "\0" . 'customer', '' . "\0" . 'App\\Entity\\CustomerMeta' . "\0" . 'id', '' . "\0" . 'App\\Entity\\CustomerMeta' . "\0" . 'name', '' . "\0" . 'App\\Entity\\CustomerMeta' . "\0" . 'value', '' . "\0" . 'App\\Entity\\CustomerMeta' . "\0" . 'visible', '' . "\0" . 'App\\Entity\\CustomerMeta' . "\0" . 'type', '' . "\0" . 'App\\Entity\\CustomerMeta' . "\0" . 'required', '' . "\0" . 'App\\Entity\\CustomerMeta' . "\0" . 'constraints'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerMeta $proxy) {
