...
$c->addHandler(($this->privates['security.authentication.rememberme.services.simplehash.secured_area'] ?? $this->load('getSecurity_Authentication_Rememberme_Services_Simplehash_SecuredAreaService.php')));
...
return $this->privates['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ($this->privates['security.authentication.listener.guard.secured_area'] ?? $this->load('getSecurity_Authentication_Listener_Guard_SecuredAreaService.php'));
    yield 3 => ($this->privates['security.authentication.listener.form.secured_area'] ?? $this->load('getSecurity_Authentication_Listener_Form_SecuredAreaService.php'));
    yield 4 => ($this->privates['security.authentication.listener.rememberme.secured_area'] ?? $this->load('getSecurity_Authentication_Listener_Rememberme_SecuredAreaService.php'));
    yield 5 => ($this->privates['security.authentication.listener.anonymous.secured_area'] ?? $this->load('getSecurity_Authentication_Listener_Anonymous_SecuredAreaService.php'));
    yield 6 => ($this->privates['security.access_listener'] ?? $this->load('getSecurity_AccessListenerService.php'));
}, 7), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver(NULL, NULL))), $b, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint(($this->services['http_kernel'] ?? $this->getHttpKernelService()), $b, 'fos_user_security_login', false), NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->load('getMonolog_Logger_SecurityService.php')), false), $c, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('secured_area', 'App\\Security\\UserChecker', '.security.request_matcher.3UEFixr', true, false, 'security.user.provider.concrete.chain_provider', 'secured_area', 'security.authentication.form_entry_point.secured_area', NULL, NULL, [0 => 'guard', 1 => 'form_login', 2 => 'remember_me', 3 => 'anonymous'], NULL));
