...
include_once $this->targetDirs[3].'/vendor/jms/serializer/src/Naming/IdenticalPropertyNamingStrategy.php';
...
$a = new \Metadata\Driver\FileLocator(['FOS\\UserBundle' => ($this->targetDirs[3].'/src/../config/serializer/FOS/UserBundle'), 'App' => ($this->targetDirs[3].'/src/../config/serializer/App')]);
