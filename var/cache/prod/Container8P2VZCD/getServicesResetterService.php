...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->privates['form.choice_list_factory.cached'])) + (int) (isset($this->privates['debug.stopwatch'])) + (int) (isset($this->privates['form.type.entity'])) + (int) (isset($this->privates['monolog.handler.main'])) + (int) (isset($this->privates['monolog.handler.console'])) + (int) (isset($this->services['security.token_storage'])) + (int) (isset($this->privates['swiftmailer.email_sender.listener'])) + (int) (isset($this->services['fos_rest.view_handler'])) + (int) (isset($this->privates['webpack_encore.tag_renderer'])) + (int) (isset($this->privates['webpack_encore.entrypoint_lookup[_default]']));
}), ['form.choice_list_factory.cached' => 'reset', 'debug.stopwatch' => 'reset', 'form.type.entity' => 'reset', 'monolog.handler.main' => 'reset', 'monolog.handler.console' => 'reset', 'security.token_storage' => 'setToken', 'swiftmailer.email_sender.listener' => 'reset', 'fos_rest.view_handler.default' => 'reset', 'webpack_encore.tag_renderer' => 'reset', 'webpack_encore.entrypoint_lookup[_default]' => 'reset']);
